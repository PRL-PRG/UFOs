...
test_that("ufo integer subscript: hash str 0,1,0,N",                  {test_ufo_subscript(n=100000, as.character(c(1, 0, 1, 100000)),                                    ufo_integer         )})
...
test_that("ufo integer+names subscript: hash str 0,1,0,N",            {test_ufo_subscript(n=100000, as.character(c(1, 0, 1, 100000)),                                    ufo_integer, named=T)})
